...
def detectFaceDlibMMOD(detector, frame, inHeight=300, inWidth=0):
    ...
    print('frameDlibMMOD.shape[0]:',frameDlibMMOD.shape[0])
    print('frameDlibMMOD.shape:', frameDlibMMOD.shape)
...
if __name__ == "__main__":
    ...
    #parser.add_argument("--video", type=str, default="./videos/baby.mp4", help="Path to video file")
    #parser.add_argument("--video", type=str, default="./videos/neck-exercise.mp4", help="Path to video file")
    parser.add_argument("--video", type=str, default="./videos/rowing.mp4", help="Path to video file")
